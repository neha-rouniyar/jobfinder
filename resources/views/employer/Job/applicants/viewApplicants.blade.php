        ...
        <div class="pagetitle">
          ...
          <nav>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">View Applicants</li>
          ...
          <table class="table .table-borderless">
           ...
           <tbody>
            ...
            <tr>
                ...
                <td>{{$item->title}}</td>
                <td>
                    <a href=""><button type="button" class="btn btn-info btn-sm">View Applicant Details</button></a>
                </td>
            </tr>
        </tbody>
        @endforeach
