...
class JobController extends Controller
{
    ...
    {
        // Assuming you have the authenticated company user
            $companyUser = Auth::user();

            // Retrieve jobs posted by the company
            $jobs = $companyUser->jobs;

            // Loop through each job and get the applicants
            foreach ($jobs as $job) {
                $applicants = $job->applicants; // This will give you a collection of applicants for each job
                // Now you can use $applicants as needed
            }

        return view('employer.Job.applicants.viewApplicants');
    }
}
