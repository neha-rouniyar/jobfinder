...
//company only
Route::get('/employer/my-profile',[ProfileContr::class,'myProfile'])->name('company.profile');



//common routes
Route::get('/admin-dashboard',[AdminController::class,'index'])->name('admin.new.job');
