      ...
      <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{route('admin.job.update')}}" method="POST" class="row g-3">
                    @csrf
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" value="{{old('title')}}" name="experience" class="form-control" id="inputPassword4">
                    </div>
                    <div class="col-md-6">
                        <label for="inputEmail4" class="form-label">Job Description</label>
                        <textarea class="form-control" value="{{old('title')}}" name="desc" id="floatingTextarea" style="height: 100px;"></textarea>
                    </div>
                    <div class="col-md-6">
