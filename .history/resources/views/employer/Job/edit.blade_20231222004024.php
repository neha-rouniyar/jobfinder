            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.job.update',$jobData->id)}}" method="POST" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control"  name="desc" id="floatingTextarea" style="height: 100px;">{{$jobData->desc}}</textarea>
                    </div>
                    <div class="col-md-6">
                        <label for="inputAddress" class="form-label">Company Location</label>
                        <input type="text" name="address" value="{{$jobData->location}}" class="form-control" id="inputAddress">
                    </div>
                    <div class="col-md-6">
