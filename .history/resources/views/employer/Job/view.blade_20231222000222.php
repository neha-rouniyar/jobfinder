    ...
    <div class="pagetitle">
      ...
      <table class="table .table-borderless">
        ...
        <tbody>
            ...
            <td>{{$data->deadline}}</td>
            <td>
                <a href="#"><button type="button" class="btn btn-warning rounded-pill" data-bs-toggle="modal" data-bs-target="#largeModal" data-job-id="your_job_id_here">Update</button></a>
