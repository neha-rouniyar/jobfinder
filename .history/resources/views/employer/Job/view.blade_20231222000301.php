    ...
    <div class="pagetitle">
      ...
      <table class="table .table-borderless">
        ...
        <tbody>
            ...
            <td>{{$data->deadline}}</td>
            <td>
                <a href="#"><button type="button" class="btn btn-warning rounded-pill" data-bs-toggle="modal" data-bs-target="#largeModal" data-job-id="job_id">Update</button></a>
  ...
  <script>
    $(document).ready(function() {
        $('#largeModal').on('show.bs.modal', function (event) {
            ...
            // Update modal content based on the jobId
            // For example, you can make an AJAX request to fetch data for the job and populate the modal fields.
            // Here, I'm just updating the input fields with the jobId.
            $('#largeModal').find('#inputNanme4').val(jobId);
