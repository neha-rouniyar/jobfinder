            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.job.update',$jobData->id)}}" method="POST" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <textarea class="form-control" value="{{$jobData->desc}}" name="desc" id="floatingTextarea" style="height: 100px;">{{$jobData->desc}}</textarea>
                    </div>
                    <div class="col-md-6">
                        <label for="inputAddress" class="form-label">Company Location</label>
                        <input type="text" name="address" value="{{$jobData->address}}" class="form-control" id="inputAddress">
                    </div>
                    <div class="col-md-6">
                        <label for="inputAddress" class="form-label">Company Contact</label>
                        <input type="number" name="contact" value="{{$jobData->contact}}" class="form-control" id="inputAddress">
                    </div>
                    <div class="col-md-6">
                        <label for="inputAddress" class="form-label">Salary</label>
                        <input type="text" name="salary" value="{{$jobData->salary}}" class="form-control" id="inputAddress">
                    </div>
                    <div class="col-md-6">
                        <label for="inputAddress" class="form-label">Job Type</label>
                        <input type="text" name="jobType" value="{{$jobData->job_type}}" class="form-control" id="inputAddress">
                    </div>
                    <div class="col-md-6">
                        <label for="inputAddress" class="form-label">Deadline</label>
                        <input type="date" name="deadline" value="{{$jobData->deadline}}" class="form-control" id="inputAddress">
                    </div>
