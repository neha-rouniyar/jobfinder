            ...
            <div class="card-body">
                ...
                <form action="{{route('admin.job.update',$jobData->id)}}" method="POST" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" value="{{}}" name="title" class="form-control" id="inputNanme4">
                    </div>
                    <div class="col-md-6">
                        <label for="inputPassword4" class="form-label">Required Experience</label>
                        <input type="text" value="{{old('experience')}}" name="experience" class="form-control" id="inputPassword4">
                    </div>
                    <div class="col-md-6">
                        <label for="inputEmail4" class="form-label">Job Description</label>
                        <textarea class="form-control" value="{{old('desc')}}" name="desc" id="floatingTextarea" style="height: 100px;"></textarea>
                    </div>
                    <div class="col-md-6">
