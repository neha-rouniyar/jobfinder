...
<div class="container">
    <div class="card-body">
        <h1 style="text-align: center; margin-top: 3%" >Employer Register form</h1>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="c_contact" name="c_contact" class="form-control" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="c_location">Company Location:</label>
                        <input type="text" id="c_location" name="c_location" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label for="resume">Company Description:</label>
