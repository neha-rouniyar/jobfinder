            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" val  id="fullName" name="fullName" class="form-control" >
                        @error('fullName')
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" val id="email" name="email" class="form-control" >
                         @error('email')
                            <p style="color: red">{{$message}}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" val id="contact" name="contact" class="form-control" >
                         @error('contact')
                            <p style="color: red">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" val id="address" name="address" class="form-control" >
                         @error('address')
                            <p style="color: red">{{$message}}</p>
                        @enderror
                    </div>
