        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('user.applyJob',$jobDetailData->id)}}" method="POST" class="row g-3" enctype="multipart/form-data">
                        @csrf
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="file" name="coverLetter"  class="form-control" id="inputAddress">
                            @error('coverLetter')
