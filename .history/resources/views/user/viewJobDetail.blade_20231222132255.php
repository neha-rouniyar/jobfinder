                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="address" value="{{$jobDetailData->location}}" class="form-control" id="inputAddress">
                        </div>
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Company Contact</label>
                            <input type="number" name="contact" value="{{$jobDetailData->contact}}"  class="form-control" id="inputAddress">
                        </div>
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Salary</label>
                            <input type="text" name="salary" value="{{$jobDetailData->salary}}" class="form-control" id="inputAddress">
                        </div>
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Job Type</label>
                            <input type="text" name="jobType" value="{{$jobDetailData->job_type}}" class="form-control" id="inputAddress">
                        </div>
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Deadline</label>
                            <input type="date" name="deadline" value="{{$jobDetailData->deadline}}" class="form-control" id="inputAddress">
                        </div>
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Upload a </label>
                            <input type="date" name="deadline" value="{{$jobDetailData->deadline}}" class="form-control" id="inputAddress">
                        </div>
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Deadline</label>
