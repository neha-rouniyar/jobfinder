...
@section('content')
      ...
      <main id="main" class="main">
        ...
        @if (session('resumeUpdated'))
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <p style="color: rgb(128, 17, 0)8, 28, 0)">{{session('resumeUpdated')}}</p>
                          ...
                          <div class="col-md-8 col-lg-9">
                            ...
                            <div class="pt-2">
                              <div class="form-group">
                                ...
                                <a href="{{ asset('uploads/' . Auth::user()->media->resume) }}" download>{{ Auth::user()->media->resume }}
<span class="input-group-text" id="file-label">{{ Auth::user()->media->resume }}</span></a>
                                {{-- {{ asset('images/' . Auth::user()->media->profileImage) }} --}}
