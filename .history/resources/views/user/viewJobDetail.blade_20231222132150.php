                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" value="{{$jobDetailData->title}}" disabled name="experience" class="form-control" id="inputPassword4">
                        </div>
                        <div class="col-md-6">
                            <label for="inputEmail4" class="form-label">Job Description</label>
                            <textarea class="form-control"  disabled name="desc" id="floatingTextarea" style="height: 100px;">{{$jobDetailData->title}}</textarea>
                        </div>
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Company Location</label>
                            <input type="text" name="address" value="{{$jobDetailData->title}}" class="form-control" id="inputAddress">
                        </div>
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Company Contact</label>
                            <input type="number" name="contact" value="{{$jobDetailData->title}}" value="{{$jobDetailData->title}}" class="form-control" id="inputAddress">
                        </div>
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Salary</label>
                            <input type="text" name="salary" value="{{$jobDetailData->title}}" class="form-control" id="inputAddress">
                        </div>
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Job Type</label>
                            <input type="text" name="jobType" value="{{$jobDetailData->title}}" class="form-control" id="inputAddress">
                        </div>
                        <div class="col-md-6">
                            <label for="inputAddress" class="form-label">Deadline</label>
                            <input type="date" name="deadline" value="{{$jobDetailData->title}}" class="form-control" id="inputAddress">
                        </div>
