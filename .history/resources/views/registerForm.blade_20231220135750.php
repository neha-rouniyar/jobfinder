            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" value="{{old('fullName')}}" id="email" name="email" class="form-control" >
                         @error('email')
                            <p style="color: red">{{$message}}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" value="{{old('fullName')}}" id="contact" name="contact" class="form-control" >
                         @error('contact')
                            <p style="color: red">{{$message}}</p>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" value="{{old('fullName')}}" id="address" name="address" class="form-control" >
                         @error('address')
                            <p style="color: red">{{$message}}</p>
                        @enderror
                    </div>
