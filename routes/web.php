...
Route::get('/admin/view-applicants',[JobController::class,'viewApplicants'])->name('admin.viewApplicants');
...
Route::get('/user/view-applied-jobs',[ProfileController::class,'viewAppliedJobs'])->name('user.view.appliedJobs');
Route::post('/user/update-resume',[ProfileController::class,'updateResume'])->name('update.resume');
